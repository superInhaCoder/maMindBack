...
from myapp.apis import GoogleLoginView, MyView, UserView, TestLoginView, UserCheckView, TestListView, UserCheckCalView, TestItemView
...
urlpatterns = [
    ...
    path('user/goal', UserCheckView.as_view()),
